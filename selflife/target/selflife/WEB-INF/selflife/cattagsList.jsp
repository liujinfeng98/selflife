...
<div class="jumbotron jumbotron_custom">
  <div class="container">
	<div class="list-group" style="color:black;background-color:#efeeee;">
	  <c:forEach var="cattag" items="${hashmap.cattags}" varStatus="status">
       <a class="list-group-item" style="font-size:18px;line-height:2.4;padding-left:15px;" href="/queryCommand/toUpdateCatTag/${cattag.id}">${status.index+1}. ${cattag.name}</a></li>
 		</c:forEach>
     </div>
  </div>
</div>
