  ...
  <div class="container">
	<div class="list-group" style="color:black;background-color:#efeeee;">
	  <c:forEach var="statics" items="${hashmap.staticses}" varStatus="status">
       <a class="list-group-item" style="font-size:18px;line-height:2.4;padding-left:15px;" href="/queryCommand/time/${statics.name}">${status.index+1}. ${statics.name}<span style="float:right;padding-right:15px;color:green;">(${statics.count})</span></a></li>
 		</c:forEach>
     </div>
  </div>
</div>
