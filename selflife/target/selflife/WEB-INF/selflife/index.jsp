...
<div class="jumbotron jumbotron_custom">
  <div class="container">
	<div class="list-group" style="color:black;background-color:#efeeee;">
	  <c:forEach var="command" items="${hashmap.commands}" varStatus="status">
       <a class="list-group-item" style="font-size:18px;line-height:2.4;padding-left:15px;" href="/queryCommand/command/${command.ec_command_id}">${status.index+1}. ${command.ec_command_title}</a></li>
 		</c:forEach>
     </div>
  </div>
</div>
